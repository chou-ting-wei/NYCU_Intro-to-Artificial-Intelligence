...
class Ngram:
    ...
    def compute_perplexity(self, df_test) -> float:
        ...
        perplexity = 0
        for document_tokenize in tqdm(corpus, desc="Progress"):
    ...
    def train_sentiment(self, df_train, df_test):
        ...
        for i in tqdm(range(len(df_train['review'])), desc="Converting train data to embeddings"):
        ...
        for i in tqdm(range(len(df_test['review'])), desc="Converting test data to embeddings"):
